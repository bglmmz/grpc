...
```
$ go get -u github.com/bglmmz/grpc/examples/helloworld/greeter_client
$ go get -u github.com/bglmmz/grpc/examples/helloworld/greeter_server
```
...
1. Rebuild the generated Go code
   ...
   ```
   $ go generate github.com/bglmmz/grpc/examples/helloworld/...
   ```
